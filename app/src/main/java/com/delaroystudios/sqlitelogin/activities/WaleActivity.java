 ...
 */
public class WaleActivity extends DesignActivity{
   private ImageButton b1,b2,b3,b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sw.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                myView.setImageResource(R.drawable.un3);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sw.setImageResource(R.drawable.f1);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "ลายนี้บวกราคาเพิ่ม 200บาท",
                        Toast.LENGTH_LONG).show();
                sw.setImageResource(R.drawable.f2);
                Bundle bundle = getIntent().getExtras();
                int Price = bundle.getInt("price");
                 total=Price +200;
                textView.setText(Text1+total+Text2);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "ลายนี้บวกราคาเพิ่ม 300บาท",
                        Toast.LENGTH_LONG).show();
                sw.setImageResource(R.drawable.f3);
                Bundle bundle = getIntent().getExtras();
                int Price = bundle.getInt("price");
                total=Price +300;
                textView.setText(Text1+total+Text2);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "ลายนี้บวกราคาเพิ่ม 250บาท",
                        Toast.LENGTH_LONG).show();
                sw.setImageResource(R.drawable.f4);
                Bundle bundle = getIntent().getExtras();
                int Price = bundle.getInt("price");
                 total=Price +250;
                textView.setText(Text1+total+Text2);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent myIntent = new Intent(WaleActivity.this,
                            BodyActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.member) {
            finish();
            Intent goMain = new Intent(WaleActivity.this, EditActivity.class);
