 ...
 */
public class Wale3Activity extends DesignActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sw.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                myView.setImageResource(R.drawable.un1);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "ลายนี้บวกราคาเพิ่ม 200บาท",
                        Toast.LENGTH_LONG).show();
                sw.setImageResource(R.drawable.c3);
                Bundle bundle = getIntent().getExtras();
                int Price = bundle.getInt("price");
                int total=Price +200;
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "ลายนี้บวกราคาเพิ่ม 300บาท",
                        Toast.LENGTH_LONG).show();
                sw.setImageResource(R.drawable.c2);
                Bundle bundle = getIntent().getExtras();
                int Price = bundle.getInt("price");
                int total=Price +300;
                textView.setText(Text1+total+Text2);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "ลายนี้บวกราคาเพิ่ม 250บาท",
                        Toast.LENGTH_LONG).show();
                sw.setImageResource(R.drawable.c4);
                Bundle bundle = getIntent().getExtras();
                int Price = bundle.getInt("price");
                int total=Price +250;
                textView.setText(Text1+total+Text2);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(Wale3Activity.this,
                        BodyActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.member) {
            finish();
            Intent goMain = new Intent(Wale3Activity.this, EditActivity.class);
