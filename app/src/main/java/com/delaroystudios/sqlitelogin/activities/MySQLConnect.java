...
public class MySQLConnect {
    ...
    private String URL = "http://192.168.1.9/", GET_URL = "android/get_post.php?id=10", SENT_URL = "android/sent_post.php";
    ...
    public void showJSON(String response){
        ...
        try{
            ...
            for(int i = 0; i < result.length(); i++){
                ...
                orId = collectData.getInt("orId");
                String orderid = Integer.toString(orId);
                status = collectData.getString("status");
                String iteme = "Order ID : "+orderid+"  สถานะ : "+status;
                list.add(iteme);
            }
