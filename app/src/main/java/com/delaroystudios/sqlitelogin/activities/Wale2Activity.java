 ...
 */
public class Wale2Activity extends DesignActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sw.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                myView.setImageResource(R.drawable.un);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(Wale2Activity.this,
                        BodyActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.member) {
            finish();
            Intent goMain = new Intent(Wale2Activity.this, EditActivity.class);
